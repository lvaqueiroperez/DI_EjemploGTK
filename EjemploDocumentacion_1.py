#EJERCICIO PARA USAR LA DOCUMENTACIÓN
...
class Fiestra(Gtk.Window):
    """
    Clase para trabajar los eventos de distintos componentes.
    """
    def __init__(self):
        """
        Constructor de la clase Fiestra.
        """
    ...
    def on_txtDende_activate(self, entry):
        #DOCUMENTACIÓN
        """
        Método de la señal activate del control txtDende.

        Este método recoge el texto en el Gtk.Entry txtDende y lo inserta .... etc etc.

        :param entry: Origen del vuelo
        :return: None:
        """
        fin = self.bufferTxv.get_end_iter()
